    ...
    <div className={styles.container}>
      <section className={styles.section}>
        ...
        <p className={styles.headingDescription}>
          ...
          trumpet. Today, Vincent Bach offers a complete line of USA-made
          student trumpets, intermediate trumpets, and professional trumpets.
          Each Bach trumpet is handcrafted using the highest quality brass found
          here in the Midwest region of the United States. Vincent Bach
          professional and intermediate trumpet models are made in Elkhart,
          Indiana while a full line of Bach student trumpets are made in
          Eastlake, Ohio. Each handcrafted Bach trumpet offers the highest
          degree of durability, unparalleled performance, and a signature Bach
          sound that is preferred by more professionals than any other brand for

  ...
  <div className={styles.container}>
    <section className={styles.section}>
      ...
      <p className={styles.headingDescription}>
        ...
        trombone in today’s global market. Every Bach trombone is hand crafted,
        focusing on precision manufacturing and detail. Today, the Bach
        Stradivarius trombones remain the sound choice for the most discerning
        musicians worldwide.
      </p>
    </section>
